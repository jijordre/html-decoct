...
function test_suite() {
    ...
    suite.only('some context', function () { });
    suite.skip('some context', function () { });
    suite('some context', function () {
        this.timeout(2000);
    });
}
...
function test_test() {
    ...
    test('does something', function (done) { done(); });
    test.only('does something', function () { });
    test.skip('does something', function () { });
    test('does something', function () {
        this.timeout(2000);
    });
}
function test_specify() {
    ...
    specify('does something', function (done) { done(); });
    specify.only('does something', function () { });
    specify.skip('does something', function () { });
    specify('does something', function () {
        this.timeout(2000);
    });
}
function test_before() {
    ...
    before("my description", function (done) { });
}
function test_setup() {
    setup(function () { });
...
function test_after() {
    ...
    after("my description", function () { });
    after("my description", function (done) { });
}
